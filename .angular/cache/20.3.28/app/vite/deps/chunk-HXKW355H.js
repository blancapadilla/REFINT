import {
  ...
  s as s2,
  t
} from "./chunk-B4V2TXNO.js";
import {
  a,
  c as c3,
  o as o3
} from "./chunk-MSSE3ZYO.js";
import {
  o as o2
...
import {
  ...
  s,
  u
} from "./chunk-XE3BW62W.js";
import {
  NgControl
} from "./chunk-65KGITHL.js";
import {
  ActivatedRoute,
...
// node_modules/@ionic/core/components/p-BWEZufiK.js
...
var x = (n4) => ({ create: (o8) => N(n4, o8), dismiss: (o8, e5, t5) => E(document, o8, e5, n4, t5), getTop: () => __async(null, null, function* () {
  return L(document, n4);
}) });
var T = x("ion-alert");
var k = x("ion-action-sheet");
var j2 = x("ion-loading");
var A = x("ion-modal");
var C = x("ion-picker-legacy");
var S = x("ion-popover");
var B = x("ion-toast");
var D = (n4) => {
...
var I = (n4) => (n4.hasAttribute("id") || (n4.id = "ion-overlay-" + ++w2), n4.id);
...
var q = (n4) => {
  0 === y2 && (y2 = 1, n4.addEventListener("focus", ((o8) => {
    ((n5, o9) => {
      const e5 = L(o9, "ion-alert,ion-action-sheet,ion-loading,ion-modal,ion-picker-legacy,ion-popover"), i6 = n5.target;
      e5 && i6 && (e5.classList.contains(nn) || (e5.shadowRoot ? (() => {
        if (e5.contains(i6)) e5.lastFocus = i6;
        else if ("ION-TOAST" === i6.tagName) P(e5.lastFocus, e5);
        else {
          const n6 = e5.lastFocus;
          f3(e5), n6 === o9.activeElement && h3(e5), e5.lastFocus = o9.activeElement;
        }
      })() : (() => {
        if (e5 === i6) e5.lastFocus = void 0;
        else if ("ION-TOAST" === i6.tagName) P(e5.lastFocus, e5);
        else {
          const n6 = c(e5);
          if (!n6.contains(i6)) return;
          const a5 = n6.querySelector(".ion-overlay-wrapper");
          if (!a5) return;
          if (a5.contains(i6) || i6 === n6.querySelector("ion-backdrop")) e5.lastFocus = i6;
          else {
            const n7 = e5.lastFocus;
            f3(a5, e5), n7 === o9.activeElement && h3(a5, e5), e5.lastFocus = o9.activeElement;
          }
        }
      })()));
    })(o8, n4);
...
var X = (n4, o8, e5, i6, a5) => __async(null, null, function* () {
  var r5, d2;
  if (n4.presented) return;
  "ION-TOAST" !== n4.el.tagName && Z(n4.el);
  const l7 = n4.el, c8 = "ION-TOAST" !== l7.tagName && false !== l7.focusTrap && O2(l7);
  if (n4.presented = true, n4.willPresent.emit(), c8) {
    const n5 = z(document).querySelector("ion-router-outlet, #ion-view-container-root");
    !!n5 && n5.contains(l7) || M2(true), document.body.classList.add(i);
  }
  null === (r5 = n4.willPresentShorthand) || void 0 === r5 || r5.emit();
  const m3 = y(n4), v3 = n4.enterAnimation ? n4.enterAnimation : n.get(o8, "ios" === m3 ? e5 : i6);
  if ((yield G(n4, v3, n4.el, a5)) && (n4.didPresent.emit(), null === (d2 = n4.didPresentShorthand) || void 0 === d2 || d2.emit()), n4.keyboardClose && (null === document.activeElement || !n4.el.contains(document.activeElement))) {
    const o9 = c(n4.el).querySelector('[role="dialog"][tabindex]'), e6 = null != o9 ? o9 : n4.el;
    try {
      e6.focus({ preventScroll: true });
    } catch (n5) {
      e6.focus();
    }
  }
  n4.el.removeAttribute("aria-hidden"), n4.el.removeAttribute("inert");
});
...
//# sourceMappingURL=chunk-HXKW355H.js.map
