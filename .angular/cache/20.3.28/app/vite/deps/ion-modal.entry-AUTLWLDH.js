...
import {
  ...
  present,
  setOverlayId
} from "./chunk-NRIFU3OF.js";
import {
  CoreDelegate,
  attachComponent,
  detachComponent
} from "./chunk-PVRN35WK.js";
import {
  getClassMap
...
import {
  deepReady,
  waitForMount
} from "./chunk-OVW2NQZV.js";
import {
  createAnimation
} from "./chunk-KPLHMFDO.js";
import {
  getIonMode
} from "./chunk-PERQPSHT.js";
import {
  clamp,
  getElementRoot,
  hasLazyBuild,
...
var Modal = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({
      key: "bad33199a939bd1e289b3b3f936c676ba403224f",
      "no-router": true,
      // Allow the modal to be navigable when the handle is focusable
      tabIndex: isHandleCycle && isSheetModalWithHandle ? 0 : -1
    }, htmlAttributes, { style: {
      zIndex: `${2e4 + this.overlayIndex}`
    }, class: Object.assign({ [mode]: true, ["modal-default"]: !isCardModal && !isSheetModal, [`modal-card`]: isCardModal, [`modal-sheet`]: isSheetModal, [`modal-no-expand-scroll`]: isSheetModal && !expandToScroll, "overlay-hidden": true, [FOCUS_TRAP_DISABLE_CLASS]: focusTrap === false }, getClassMap(this.cssClass)), onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle, onFocus: this.onModalFocus }), h("ion-backdrop", { key: "d098688a65fb2d1befb255f0e59fd4c00b401092", ref: (el) => this.backdropEl = el, visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === "ios" && h("div", { key: "96cd2e59a7d1c0de7c9afb8f8d366367b09fbc93", class: "modal-shadow" }), h("div", Object.assign({
      ...
      /*
                ...
                */
      role: "dialog"
    }, inheritedAttributes, { "aria-modal": "true", tabIndex: -1, class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => this.wrapperEl = el }), showHandle && h("button", {
      key: "714d9904fcc8105b21e2bb66cdc032bffd685d72",
      class: "modal-handle",
    ...
    }), h("slot", { key: "79dfbeb3fe5eee7dc3a243ad880d3f63184f3ab7", onSlotchange: this.onSlotChange })));
  }
  get el() {
...
//# sourceMappingURL=ion-modal.entry-AUTLWLDH.js.map
